...
#         # Colors
#         self.bg_color = "#7e7574"
#         self.board_color = "#0a0a0a"
#         self.x_color = "#FF5733"
#         self.o_color = "#ee13d6"
#         self.highlight_color = "#0d17ef"
#         self.won_board_colors = {
#             'X': "#FF5733",
#             'O': "#ee13d6",
#             'D': "#b2bec3",  # Add this line for drawn boards
#             ' ': "#dcdde1"
#         }
...
#         # Mode selection
#         self.mode_label = tk.Label(self.control_frame, text="Mode:", bg=self.bg_color, fg="#ffffff")
...
#         self.mode_menu.config(bg="#a29bfe", fg="#ffffff", activebackground="#6c5ce7", activeforeground="#ffffff")
#         self.mode_menu["menu"].config(bg="#a29bfe", fg="#ffffff", activebackground="#6c5ce7", activeforeground="#ffffff")
#         self.mode_menu.pack(side=tk.LEFT, padx=5)
        
#         # # AI difficulty
#         # self.difficulty_label = tk.Label(self.control_frame, text="AI Difficulty:", bg=self.bg_color, fg="#ffffff")
...
#         # self.difficulty_menu.config(bg="#a29bfe", fg="#ffffff", activebackground="#6c5ce7", activeforeground="#ffffff")
#         # self.difficulty_menu["menu"].config(bg="#a29bfe", fg="#ffffff", activebackground="#6c5ce7", activeforeground="#ffffff")
...
#                                     bg="#00b894", fg="#ffffff", activebackground="#019875", padx=10)
...
#                                   bg=self.bg_color, fg="#ffffff", font=("Arial", 14))
...
#                     row_small_buttons = []
#                     for n in range(3):
#                         btn = tk.Button(board_frame, text=' ', width=3, height=1, font=('Helvetica', 14),
#                                        bg="#ffffff", command=lambda i=i, j=j, m=m, n=n: self.make_move(i, j, m, n))
...
#                 for m in range(3):
#                     for n in range(3):
#                         self.buttons[i][j][m][n].config(text=' ', bg="#ffffff", state=tk.NORMAL)
